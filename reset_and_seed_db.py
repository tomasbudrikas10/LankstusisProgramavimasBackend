...
def reset_and_seed_db():
    ...
    try:
        ...
        cursor.execute(add_produktas_query, ("Produktas A", "Aprasymas A", "Paveiksliukas A", "Gamintojas A", "Produkto Puslapis A", 2))
        cursor.execute(add_produktas_query, ("Produktas B", "Aprasymas B", "Paveiksliukas B", "Gamintojas B", "Produkto Puslapis B", 2))
        cursor.execute(add_produktas_query, ("Produktas C", "Aprasymas C", "Paveiksliukas C", "Gamintojas C", "Produkto Puslapis C", 3))
        cursor.execute(add_produktas_query, ("Produktas D", "Aprasymas D", "Paveiksliukas D", "Gamintojas D", "Produkto Puslapis D", 3))
        cursor.execute(add_produktas_query, ("Produktas E", "Aprasymas E", "Paveiksliukas E", "Gamintojas E", "Produkto Puslapis E", 2))
        cnx.commit()
